...
export const Landing = () => {
  ...
  return (
    <div className="relative overflow-hidden">
                ...
                <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start">
                  <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                    <div className="flex items-center w-full md:w-auto">
                      ...
                      <div className="ml-4">
                        <h1 className="text-yellow-500 font-bold text-2xl font-retro">
                          Dungeon Diaries
                        </h1>
                      </div>
                    </div>
              ...
              <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div className="sm:text-center lg:text-left">
                  <h2 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl lg:text-7xl text-center">
                    ...
                    <span className="block text-yellow-500 ">social platform</span>
                  </h2>
                  ...
                  <div className="mt-8 sm:mt-8 flex justify-center space-x-4">
      ...
      <div className="max-w-7xl mx-auto">
        <section className="mt-10 mx-auto max-w-7xl px-8 sm:mt-12 sm:px-10 ">
          <div className=" lg:text-left">
            ...
            <div className="mt-8 sm:mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  gap-8">
              <div className="grid-cols-1">
                ...
                <h4 className="font-retro text-2xl font-bold mt-4">Amazing Community</h4>
                <p className="mt-4 text-gray-500">
                  A tight-knit community of the realest, bravest adventurers. Share your main quest
                  with other like-minded hustlers.
                </p>
              </div>
              <div className="grid-cols-1">
                <svg
                ...
                <h4 className="font-retro text-2xl font-bold mt-4">Weekly Polls</h4>
                <p className="mt-4 text-gray-500">
              ...
              <div className="grid-cols-1">
                ...
                <h4 className="font-retro text-2xl font-bold mt-4">Level Up</h4>
                <p className="mt-4 text-gray-500">
                  Become a dragon-tier adventurer by engaging with other adventurers. Climb up your
                  way from being a measly Slime.
                </p>
              </div>
            </div>
          </div>
